...
export const GLANCE = [
  { value: '$34.1B',   label: 'Government net position', meta: 'FY2024',        delta: 'up',   deltaText: '5.9% year over year' },
  { value: '$213.5B',  label: 'State GDP',               meta: '2025',          delta: 'up',   deltaText: '1.5% real growth' },
  { value: '$12.08B',  label: 'Appropriated budget',     meta: 'FY2026',        delta: 'down', deltaText: '11.8% vs FY2000, real per-capita' },
  { value: '$2.31B',   label: 'Total state savings',     meta: 'Rainy-day cushion' },
  { value: '23%',      label: 'Economy from oil & gas',  meta: '$60.3B in activity' },
  { value: '#3',       label: 'US wind-power producer',  meta: 'Behind Texas and Iowa' },
  { value: '50th',     label: 'Public-education ranking',meta: '49th in per-pupil spend' },
  { value: '$23.4B',   label: 'Tribal-nation output',    meta: 'About 8% of state GDP' },
  { value: '+22,912',  label: 'Net migration',           meta: '2024–25',       delta: 'up',   deltaText: 'About 63 people a day' },
  { value: '3.8%',     label: 'Unemployment',            meta: '2025',          delta: 'up',   deltaText: 'Below the US rate of 4.3%' },
  { value: '−43.7%',   label: 'Household savings',       meta: '2019–23',       delta: 'down', deltaText: 'Second-largest decline in the US' },
  { value: '#4',       label: 'Incarceration rate, US',  meta: '905 per 100k, all forms' },
];
